...
class LocaisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create local" do
    assert_difference("Local.count") do
      post locais_url, params: { local: { bairro: @local.bairro, logradouro: @local.logradouro, numero: @local.numero, referencia: @local.referencia } }
    end
  ...
  test "should update local" do
    patch local_url(@local), params: { local: { bairro: @local.bairro, logradouro: @local.logradouro, numero: @local.numero, referencia: @local.referencia } }
